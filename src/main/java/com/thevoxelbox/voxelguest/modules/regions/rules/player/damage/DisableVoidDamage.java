...
public class DisableVoidDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.VOID);
        }
    ...
    {
        return new String[]{"DisableVoidDamage", "DVD"};
    }
}
