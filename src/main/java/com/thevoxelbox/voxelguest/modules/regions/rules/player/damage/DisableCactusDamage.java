 ...
 */
@Rule(groups = {""})
public class DisableCactusDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.CONTACT);
        }
    ...
    {
        return new String[]{"DisableCactusDamage", "DCD"};
    }
