...
public class DisableFallDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.FALL);
        }
    ...
    {
        return new String[]{"DisableFallDamage", "DFaD"};
    }
