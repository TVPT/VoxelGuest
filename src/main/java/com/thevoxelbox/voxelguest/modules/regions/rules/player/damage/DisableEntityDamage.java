...
public class DisableEntityDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_ATTACK);
        }
    ...
    {
        return new String[]{"DisableEntityDamage", "DED"};
    }
