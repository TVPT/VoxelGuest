...
public class DisablePoisonDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.POISON);
        }
    ...
    {
        return new String[]{"DisablePoisonDamage", "DPoD"};
    }
