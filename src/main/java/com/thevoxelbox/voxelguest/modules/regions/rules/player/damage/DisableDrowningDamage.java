...
public class DisableDrowningDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.DROWNING);
        }
    ...
    {
        return new String[]{"DisableDrowningDamage", "DDD"};
    }
