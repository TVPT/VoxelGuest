...
public class DisableSuffocationDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.SUFFOCATION);
        }
    ...
    {
        return new String[]{"DisableSuffocationDamage", "DSuD"};
    }
