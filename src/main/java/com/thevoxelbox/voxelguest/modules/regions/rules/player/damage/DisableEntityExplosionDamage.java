 ...
 */
@Rule(groups = {""})
public class DisableEntityExplosionDamage extends GuestRegionRule
{
    @Override
    public boolean check(final Event event, final Region region, final RuleExecutionSettings settings)
    {
        ...
        {
            return entityDamageEvent.getCause().equals(EntityDamageEvent.DamageCause.ENTITY_EXPLOSION);
        }
    ...
    {
        return new String[]{"DisableEntityExplosionDamage", "DEED"};
    }
